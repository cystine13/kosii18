...
%>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header"><c:out value="${brdMstrVO.bbsNm}"/></h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
   ...
   <table border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <c:if test="${brdMstrVO.authFlag == 'Y'}">
	      <td class="button" nowrap><a class="btn btn-primary" href="<c:url value='/cop/bbs${prefix}/addBoardArticle.do'/>" onClick="javascript:fn_egov_addNotice(); return false;"><spring:message code="button.create" /></a></td>
      </c:if>
    </tr>
   </table>
  </th>
...
<table class="table table-striped table-bordered table-hover" id="dataTables-example" summary="번호, 제목, 게시시작일, 게시종료일, 작성자, 작성일, 조회수   입니다">
 <thead>
  <tr>
